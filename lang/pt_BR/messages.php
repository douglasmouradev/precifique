...
return [
    ...
    'sale' => [
        ...
        'export_ready_title' => 'Exportação de vendas pronta',
        'export_ready_body' => 'Seu arquivo CSV está disponível para download.',
    ...
    'pricing' => [
        ...
        'premium_margin_only' => 'Margem de 150% disponível apenas no Premium.',
    ],
    'billing' => [
        ...
        'already_premium' => 'Você já possui o plano Premium ativo.',
        'mercadopago_not_configured' => 'Mercado Pago não configurado.',
        'pix_generation_failed' => 'Não foi possível gerar o PIX. Tente novamente em instantes.',
        'pix_description' => 'Precifique Premium — :name',
        'payment_failed_title' => 'Falha no pagamento da assinatura',
        'payment_failed_body' => 'Atualize seu cartão no portal de cobrança para manter o Premium.',
    ],
    'onboarding' => [
